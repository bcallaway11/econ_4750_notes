...
$$
  \gamma_1 = \beta_1 + \textrm{something positive}
$$
which implies that $\gamma_1$ (i.e., ignoring $Q$) would cause us to tend to over-estimate $\beta_1$.  
